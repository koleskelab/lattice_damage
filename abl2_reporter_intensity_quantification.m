...
% abl2_reporter_intensity_quantification.m
%
% DESCRIPTION: Quantify the intensity of the tubulin reporter and Abl2
% 'reporter' on 23C and 37C storage treated biotinylated rhodamine
